...
public class MovieController : ControllerBase
{
    ...
    /// </summary>
    /// <param name="movieDto">Object with the necessary fields to create a movie</param>
    ...
    [HttpPatch("{id}")]
    public IActionResult UpdatePartialMovie(int id, [FromBody] JsonPatchDocument<UpdateMovieDto> patch)
    {
        var movie = _context.Movies.FirstOrDefault(movie => movie.Id == id);
        if (movie == null) return NotFound();
